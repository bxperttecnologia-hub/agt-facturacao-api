...
// Exemplo:
// node 03-registar-recibo.js RC9526S9096N ORIGINAL/10001
...
if (!serie) {
  console.error("Uso: node 03-registar-recibo.js <SERIE> <DOCUMENTO_ORIGINAL>");

  process.exit(1);
}

if (!documentoOriginal) {
  console.error("Informe o documento original da factura.");

  process.exit(1);
}

// Documento original que será regularizado
