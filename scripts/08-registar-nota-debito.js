...
// Testa POST /api/faturas com documentType = "ND" (Nota de Débito).
// Estrutura igual à FT: "lines" preenchido, sem "paymentReceipt".
// Ao contrário da NC, a ND segue a regra normal (soma a crédito >
// soma a débito) e NÃO exige "referenceInfo" por defeito — mas podes
// preenchê-lo se a ND estiver a corrigir um documento específico.
// Uso: node 07-registar-nota-debito.js
...
-----END PRIVATE KEY-----`,
  ...
  console.log("== POST /api/faturas (ND - Nota de Débito) ==");
